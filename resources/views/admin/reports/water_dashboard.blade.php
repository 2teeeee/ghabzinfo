<x-admin-layout title="گزارش مصرف آب" header="داشبورد گزارش مصرف آب">
    <div class="container-fluid py-4">

        {{-- 🔹 فیلتر تاریخ (شمسی) --}}
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('admin.reports.water.dashboard') }}" method="GET" class="row g-3 align-items-end">
                    @php
                        $months = [
                            3 => 'فروردین',
                            4 => 'اردیبهشت',
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0 p-3">
                    <h6 class="text-muted mb-1">مجموع مبلغ آب (ریال)</h6>
                    <h4 class="mb-0">{{ number_format($totalAmount) }}</h4>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm border-0 p-3">
                    <h6 class="text-muted mb-1">کاهش مبلغ نسبت به سال قبل</h6>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <h6 class="fw-bold text-center mb-3">⚡ مبلغ فصلی گاز (۳ ماه اخیر)</h6>
