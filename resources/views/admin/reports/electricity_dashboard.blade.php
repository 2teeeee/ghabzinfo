<x-admin-layout title="گزارش مصرف برق" header="داشبورد گزارش مصرف برق">
    <div class="container-fluid py-4">

        {{-- 🔹 فیلتر تاریخ (شمسی) --}}
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('admin.reports.electricity.dashboard') }}" method="GET" class="row g-3 align-items-end">
                    @php
                        $months = [
                            3 => 'فروردین',
                            4 => 'اردیبهشت',
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0 p-3">
                    <h6 class="text-muted mb-1">مجموع مبلغ برق (ریال)</h6>
                    <h4 class="mb-0">{{ number_format($totalAmount) }}</h4>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm border-0 p-3">
                    <h6 class="text-muted mb-1">مصرف برق (کیلووات)</h6>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <h6 class="fw-bold text-center mb-3">⚡ مصرف فصلی برق (۳ ماه اخیر)</h6>
