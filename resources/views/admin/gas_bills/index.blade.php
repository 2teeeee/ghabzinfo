<x-admin-layout title="لیست قبوض گاز" header="لیست قبوض گاز">
    <div class="container-fluid py-4">
        ...
        <x-admin-page-header
            ...
            :create-url="route('admin.gas_bills.create')"
            :search="[
                'name' => 'bill_id',
                        ...
                        @forelse($accounts as $account)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.gas_bills.show', $account->id) }}" class="btn btn-sm btn-outline-info me-1">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    ...
                                    <form action="{{ route('admin.gas_bills.destroy', $account->id) }}" method="POST"
