<x-admin-layout title="جزئیات قبض گاز" header="جزئیات قبض گاز">
    <div class="container py-4">
        ...
        <h4 class="mb-3">جزئیات قبض گاز</h4>
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-3"><strong>نوع مصرف:</strong> {{ $bill->consumption_type ?? '---' }}</div>
                </div>
            </div>
        </div>
        ...
        <a href="{{ route('admin.gas_bills.index') }}" class="btn btn-secondary mt-3">بازگشت به لیست</a>
