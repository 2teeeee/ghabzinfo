<x-main-layout>
    <div class="container py-4">
        <h4 class="mb-3">استعلام قبض آب</h4>
        ...
        <form action="{{ route('water.inquire') }}" method="POST" class="mb-4">
            @csrf
            <div class="mb-3">
                <label class="form-label" for="bill_id">شناسه قبض آب</label>
        ...
        <table class="table table-bordered mt-3">
            ...
            @foreach ($bills as $bill)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('water.show', $bill) }}" class="btn btn-sm btn-info">
                            مشاهده جزئیات
                        </a>
                    </td>
                </tr>
