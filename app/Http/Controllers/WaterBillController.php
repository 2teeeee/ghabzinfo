...
{
    protected WaterBillService $billService;

    public function __construct(WaterBillService $billService)
    {
    ...
    {
        $query = WaterAccount::query()->whereNull('deleted_at')->with(['latestPeriod', 'latestPeriod.extras', 'center.unit.organ.city']);
        ...
        return view('admin.water_bills.index', compact('accounts'));
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.water_bills.create', compact('centers', 'cities'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            // حساب اصلی قبض
            $account = WaterAccount::updateOrCreate(
            ...
            foreach ($extraData as $key => $value) {
                WaterBillExtra::create([
                    'water_bill_period_id' => $period->id,
                    'key' => $key,
                    'value' => $value,
                ]);
            }
    ...
    public function refresh(WaterAccount $account): RedirectResponse
    {
        try {
            // استعلام از سرویس
            ...
            return redirect()->route('admin.water_bills.show', $account->id)
    ...
    {
        $account = WaterAccount::withTrashed()->find($id);
